...
# START HERE 
# Step 1: Open your workspace on gitpod and install your aws cli

1. Go to aws_cli_install

2. install aws

3. aws configure, will ask for AWS Access key, Secret Access Key, and your default region.  Enter in.
...
2. In another window, go to [GitHub](https://github.com/jenmagruder/NBADataLake)

-Copy the contents inside the setup_nba_data_lake.py file

-Go back to your environment and paste the contents inside the file.
